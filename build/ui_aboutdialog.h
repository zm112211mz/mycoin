...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Silkcoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Silkcoin</b> version", 0));
...
"Copyright \302\251 2014 The Silkcoin developers", 0));
