...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 SC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 SC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 SC"));
